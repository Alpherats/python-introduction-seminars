...
def detect_english(incom_word):
    try:
        incom_word.encode(encoding='utf-8').decode('ascii')
...
database_rus = { "А":1, "В":1,"Е":1,"И":1,"Н":1,"О":1,"Р":1,"С":1, "Т":1,
...
for letter in word_up:
    if detect_english(word_up):
        point =  database_eng[letter]
    else:
        point = database_rus[letter]
    sum_points += point
print(sum_points)
